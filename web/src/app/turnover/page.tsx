...
import { Calendar, Trophy, Ruler, Search, TrendingUp, TrendingDown, CalendarDays, Store, Layers, CalendarRange, RefreshCw, Printer } from 'lucide-react';
  ...
  return (
    <>
      ...
      <main className="max-w-[1600px] mx-auto px-6 py-8 space-y-6">
        ...
        {/* Drill-down: карточка магазина (общий компонент) */}
        {drillStore && (
